# -------------------------------------
# Script: 15_mediator_max_daily_dose_mme.R
...
calculate_max_daily_dose <- function(data) {
    ...
    washout_date_limit <- unique(to_modify$washout_12mos_end_dt + lubridate::days(182))
...
saveRDS(max_daily_dose, file.path(data_dir, "mediator_12mo_max_daily_dose_mme.rds"))
