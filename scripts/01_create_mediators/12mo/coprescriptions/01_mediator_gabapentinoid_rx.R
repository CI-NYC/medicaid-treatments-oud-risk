...
otl <- otl[LINE_SRVC_BGN_DT %within% interval(washout_12mos_end_dt, 
           ...
           .(BENE_ID, LINE_SRVC_BGN_DT, washout_12mos_end_dt, NDC, NDC_QTY, flag_gab)]
...
rxl <- rxl[RX_FILL_DT %within% interval(washout_12mos_end_dt, 
                                        washout_12mos_end_dt + days(182)), 
           .(BENE_ID, RX_FILL_DT, washout_12mos_end_dt, NDC, NDC_QTY, DAYS_SUPPLY, flag_gab)]

# Export ------------------------------------------------------------------

saveRDS(otl, file.path(drv_root, "mediator_12mo_otl_gabapentinoid_rx.rds"))
saveRDS(rxl, file.path(drv_root, "mediator_12mo_rxl_gabapentinoid_rx.rds"))
...
saveRDS(gaba, file.path(drv_root, "mediator_12mo_gabapentinoid_rx_bin.rds"))
