...
opioids[, washout_12mos_end_dt := NULL]
...
# Filter data for first 17 months + 29 days after washout
out <- out[months_from_washout <= 17]

plan(sequential)

saveRDS(out, file.path(drv_root, "mme_12mo_month_summary.rds"))
