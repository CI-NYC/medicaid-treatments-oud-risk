...
dts_cohorts <- as.data.table(readRDS(file.path("/mnt/general-data/disability/create_cohort/final/sens_12mos_analysis_cohort.rds")))
...
saveRDS(claims, file.path(drv_root, "mediator_12mo_has_minimally_invasive_spinal_procedure.rds"))
