# -------------------------------------
# Script: 00_oud_12mo_to_24mo.R
# Author: Sarah Forrest / Nick Williams
# Updated:
# Purpose: Creates an indicator variable for whether or not a beneficiary in the 
#   analysis cohort had the outcome at 24 months after their washout start date. 
# Notes:
# -------------------------------------
...
saveRDS(moud_data[, .(BENE_ID, oud_24mo, oud_24mo_icd)], 
        file.path(drv_root, "oud_12mo_to_24mo.rds"))
