...
cohort <- cohort[, .(BENE_ID, washout_start_dt, washout_12mos_end_dt)]
...
claims <- claims[LINE_SRVC_BGN_DT %within% interval(washout_start_dt, washout_12mos_end_dt), 
...
saveRDS(claims, file.path(drv_root, "baseline_12mo_has_counseling.rds"))
